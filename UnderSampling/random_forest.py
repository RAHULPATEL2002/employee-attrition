...
# -------------------
data['Age'] = data['Age'].ffill()  # Fill missing Age using forward fill
...
rf_model = RandomForestClassifier(
    ...
    random_state=42,
    class_weight=None          # Because we already undersampled
)
...
plt.ylabel("Actual")
plt.title("Confusion Matrix Heatmap (Random Forest - Undersampled Data)")
plt.show()
