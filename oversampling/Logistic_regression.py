...
from imblearn.over_sampling import RandomOverSampler   # ⬅️ changed here
...
# -------------------
# 6️⃣ Train–Test Split (before oversampling)
# -------------------
...
# 🔟 Model Evaluation
# -------------------
print("\n📈 Model Evaluation (Oversampled Data):")
...
plt.ylabel("Actual")
plt.title("Confusion Matrix Heatmap (Oversampled Data)")
plt.show()
...
print("\nFinal Prediction for new employee (Oversampled Model):")
