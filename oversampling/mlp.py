# ==========================================
# 🤖 Multi-Layer Perceptron (MLP) Neural Network with Random OverSampling
# ==========================================
...
# -------------------
print("\n📈 Model Evaluation (MLP - Oversampled Data):")
...
plt.ylabel("Actual")
plt.title("Confusion Matrix Heatmap (MLP - Oversampled Data)")
plt.show()
...
print("\nFinal Prediction for new employee (MLP - Oversampled Model):")
