...
# -------------------
print("\n📈 Model Evaluation (Decision Tree - Oversampled Data):")
...
plt.ylabel("Actual")
plt.title("Confusion Matrix Heatmap (Decision Tree - Oversampled Data)")
plt.show()
...
plt.title("Decision Tree Visualization (Oversampled Data)")
plt.show()
...
print("\nFinal Prediction for new employee (Decision Tree - Oversampled Model):")
