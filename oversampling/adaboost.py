# ==========================================
# 🤖 AdaBoost Classifier with Random OverSampling
# ==========================================
...
from imblearn.over_sampling import RandomOverSampler   # 🔁 changed to OverSampler
...
# 🔟 Model Evaluation
# -------------------
print("\n📈 Model Evaluation (AdaBoost - Oversampled Data):")
...
plt.ylabel("Actual")
plt.title("Confusion Matrix Heatmap (AdaBoost - Oversampled Data)")
plt.show()
...
print("\nFinal Prediction for new employee (AdaBoost - Oversampled Model):")
