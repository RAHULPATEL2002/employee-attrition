# ==========================================
# 🤖 Naive Bayes Classifier with Random UnderSampling
# ==========================================
...
# -------------------
# 8️⃣ Feature Scaling (Optional but helps NB)
# -------------------
...
plt.ylabel("Actual")
plt.title("Confusion Matrix Heatmap (Naive Bayes - Undersampled Data)")
plt.show()
